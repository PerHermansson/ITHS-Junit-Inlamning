...
de fyra fundamentala räknesätten.
Jag har använt lite olika annoteringar, självklart
@Test, @Before, @After, men också använt mig av @Ignore för att ignorera ett testfall.
Valde också att testa @Category för att "Ignorera" ett testfall genom att bara köra
de testfall som jag ville köra genom @Category Valde också att använda mig av @BeforeClass & @AfterClass.
@BeforeClass är framförallt bra om man vill att bara någonting ska ske en gång innan alla
testfall körs och inte upprepas i varje testfall i testsuiten.
